...
import { PationShowListComponent } from '../pages/pationShowList/pationShowList-page/pationShowList-page.component';
const SPAroutes: Routes = [
  ...
  { path: 'pationShow', component: PationShowListComponent },
];
